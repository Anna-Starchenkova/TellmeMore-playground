...
const cringeRounds: CringeRound[] = [
  ...
  { stage: 1, stageLabel: "SPOT IT", mode: "replace", author: "zoe", avatar: "Z", tokens: ["He", "don't", "like", "it."], solution: ["He", "doesn't", "like", "it."], targetIndex: 1, tray: ["aren't", "doesn't", "isn't"], answer: "doesn't", reaction: "Fair, it's not really his thing.", hint: "Tap the odd word, then replace it" },
