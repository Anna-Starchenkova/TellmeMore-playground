...
const cringeRounds: CringeRound[] = [
  ...
  { stage: 2, stageLabel: "FIX IT", mode: "repair", author: "nick", avatar: "N", tokens: ["We", "did", "saw", "that", "movie."], solution: ["We", "did", "see", "that", "movie."], targetIndex: 2, answer: "see", rule: "DID → BASE VERB", reaction: "Right! The ending was wild.", hint: "Send the broken verb through repair" },
